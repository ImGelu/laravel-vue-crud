...
const create = (e) => {
    ...
    authorStore.createAuthor(data.author).then(() => {
...
<template>
    <div class="bg-white rounded-lg shadow-sm p-8 relative">
        ...
        <h1 class="font-bold text-2xl mb-4">New Author</h1>
        ...
        <form>
            ...
            <button @click="create" type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create Author</button>
        </form>
    </div>
</template>
